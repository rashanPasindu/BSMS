...
public class v_Building_Materials_Supplies extends javax.swing.JFrame {
    ...
    {
        try {
        String sql = "SELECT p.ProductID,p.ProductName,p.ProductType,p.Date,p.MRP,p.Manufacture,p.Description,p.Quantity,b.ProductWeight"
    ...
    private void initComponents() {
        ...
        productweightbox.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                productweightboxKeyReleased(evt);
            }
        });
        getContentPane().add(productweightbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 90, 227, 33));
      ...
      //ADD ITEMS KODI
       ...
       // String costperunit = costperunitbox.getText();
        ...
        building b=new building();
         ...
         b.setProducttype(producttype);
         b.setQuantity(Integer.parseInt(quantity));
         b.setDate(date);
         b.setManufacture(manufacture);
       //  b.setProfit(Float.parseFloat(profit));
         b.setSpsi(Float.parseFloat(spsi));
         b.setDescription(description);
       //  b.setCostperunit(Float.parseFloat(costperunit));
         b.setWeight( Float.parseFloat(weight));
...
*/
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try{
            ...
            String weight = jTable1.getValueAt(row, 8).toString();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        String sql="SELECT p.ProductID,p.ProductName,p.ProductType,p.Date,p.MRP,p.Manufacture,p.Description,p.Quantity,b.ProductWeight from products p,buildingmaterials b WHERE p.ProductName LIKE '%"+search+"%' AND p.ProductID=b.ProductID";
...
//            JOptionPane.showMessageDialog(null, "Please Enter a Integer value for Quantity");
    ...
    private void productweightboxKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_productweightboxKeyReleased
        String quantity = productweightbox.getText();
           int ck = 0;
        ...
        {
//            JOptionPane.showMessageDialog(null, "Please Enter a Integer value for Quantity");
            JOptionPane.showMessageDialog(this, "Please Enter a Integer value for Product weight","Error: Incompatible Type",JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_productweightboxKeyReleased
