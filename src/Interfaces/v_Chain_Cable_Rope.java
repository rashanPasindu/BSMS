...
//        costperunitbox.setText("");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 90, -1, 20));
        ...
        getContentPane().add(lengthbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 80, 227, 33));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(x==0)
        {
         ...
         //c.setProfit(Float.parseFloat(profit));
         c.setSpsi(Float.parseFloat(spsi));
         c.setDescription(description);
         //c.setCostperunit(Float.parseFloat(costperunit));
         c.setLength( Float.parseFloat(length));
...
/*
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        String sql="SELECT p.ProductID,p.ProductName,p.ProductType,p.Date,p.MRP,p.Manufacture,p.Description,p.Quantity,a.Length from products p,chains_cablesandropes a WHERE p.ProductName LIKE '%"+search+"%' AND p.ProductID=a.ProductID";
